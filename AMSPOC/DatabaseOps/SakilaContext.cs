...
namespace AMSPOC.DatabaseOps
{
    public class SakilaContext
    {
        ...
        //public List<OPLD> GetAllFilms()
        //{
        //    List<OPLD> list = new List<OPLD>();

        //    using (MySqlConnection conn = GetConnection())
        //    {
        //        conn.Open();
        //        MySqlCommand cmd = new MySqlCommand("SELECT * FROM OPLDDetails", conn);
        ...
        //                    AddressLine3 = reader.GetString("address_line3"),
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        if (reader.IsDBNull(0))
                        {
                            ...
                            lastOPLDID = Convert.ToInt32(reader["OPLDID"]); // reader.GetInt32("OPLDID");
                    }
                }
            }
